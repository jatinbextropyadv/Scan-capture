...
public class Scan_Capture_with_Pagination {
...
//   @Test
  ...
  // public void Scan_And_Capture()
        ...
        try {
            ...
            //Xpath to get the Number of pages
            
            Locator NoOfPages = page.locator("//div[@class='pt-btn-group pt-next-prev-page-btn-group']/span/span[3]");
            
            int page_count = Integer.valueOf(NoOfPages.textContent());
...
//            for (int i = 1; i <= sheet.getLastRowNum(); i++) {
                ...
                if (savedPath != null) {
                	//File
                    latestPdf = args.length > 0 ? new File(args[0]) : savedPath.toFile();
