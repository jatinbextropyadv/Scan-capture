...
public class existingChrome_latest {
...
//   @Test
  ...
  // public void Scan_And_Capture()
        ...
        try {
            ...
            // Validate id column
            if (idColumnIndex == -1) {
                System.out.println("Column 'id' not found in Excel");
                return;
            }
...
//                                boolean result2 = Keyword_Found_in_CKG(
//                                        field, pdfText, ckgSheet, formatter);
//
//                            if (result2 == true) 
//                            {
...
//                                    	System.out.println("FFFIELD111 "+field);
                                		...
                                		else 
                                		{
                                    		...
                                    		{
//                                    			System.out.println("FFFIELD 222 "+field);   
                                                if (Field_Name_FoundInInvoice == true) {
                                                    newComment = field + " not captured from invoice";
//                                                    System.out.println("FFFIELD 333 "+field);
                                                    Add_comment(newComment,existingComment,existingExpected_value,existingActual_value,commentsCell,expected_valueCell,actual_valueCell, Suppliername_new,Suppliername_old);
                                                } 
                                                else {
//                                                	System.out.println("FFFIELD 3330 "+field);
                                                	newComment = field + " not captured from invoice";
                                                	Add_comment(newComment,existingComment,existingExpected_value,existingActual_value,commentsCell,expected_valueCell,actual_valueCell, Suppliername_new,Suppliername_old);
                                                }
                                            }
...
//                                                    System.out.println("FFFIELD 333 "+field);
	                                	...
	                                	{
//	                                		System.out.println("FFFIELD 444 "+field);
	                                		if ("-".equals(Suppliername_old) || Suppliername_old.contains("NON")) 
	                                		{
...
//                                	Add_comment(newComment,commentsCell,expected_valueCell,actual_valueCell, Suppliername_new,Suppliername_old);
                                }
...
//                        workbook.write(fos);
                    ...
                    System.out.println("???????????? rec " + i + " | link " + (j + 1) + " ????????????");
